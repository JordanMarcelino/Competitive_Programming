...
public class ViralAdvertising {
    ...
    void solve() throws IOException {
        ...
        int[] shared = new int[N]; shared[0] = 5;
        int[] liked = new int[N]; liked[0] = 2;

        for (int i = 1; i < N; i++) {
            shared[i] = shared[i-1] / 2 * 3;
            liked[i] = liked[i-1] + shared[i] / 2;
        }

        out.println(liked[N-1]);
    }
...
//            out.println("Case #" + i + ": ");
    ...
    public static void main(String[] args) throws IOException {
        ViralAdvertising driver = new ViralAdvertising();
