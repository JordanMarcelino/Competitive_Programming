...
public class BeautifulDaysAtTheMovie {
    ...
    public BeautifulDaysAtTheMovie() {
    }
    ...
    void solve() throws IOException {
        ...
        for (int i = dayStart; i <= dayEnd; i++) {
            int reversed =
                    Integer.parseInt
                            (
                                    new StringBuilder(new String(Integer.toString(i).toCharArray()))
                                            .reverse()
                                            .toString()
                            );
            if(Math.abs(i - reversed) % k == 0) ans++;
        }
...
//            out.println("Case #" + i + ": ");
    ...
    public static void main(String[] args) throws IOException {
        BeautifulDaysAtTheMovie driver = new BeautifulDaysAtTheMovie();
